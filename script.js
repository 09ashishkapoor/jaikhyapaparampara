...
const translations = {
    en: {
        ...
        'about-p1': 'This website is offered in seva. The books, articles, and teachings shared here are placed at the feet of Guru Shrestha in obedience to Aadesh.',
        'about-p2': 'These writings are offerings of devotion for those who seek truth through the Khyapa Parampara. Many have already been shared, and more will continue to be added with the same intention.',
    ...
    hi: {
        ...
        'footer-meta': '© ' + CURRENT_YEAR + ' कालीपुत्र-आशीष। सारा ज्ञान साझा करने के लिए हमेशा मुफ़्त है।',
...
function setLanguage(lang) {
    ...
    [
        ...
        document.querySelectorAll(`[${dataAttr}]`).forEach(element => {
            ...
            const newContent = translations[lang] && translations[lang][key];
            if (newContent && element.getAttribute(targetAttr) !== newContent) {
                element.setAttribute(targetAttr, newContent);
            }
        });
    });
