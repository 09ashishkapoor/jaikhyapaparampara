...
test.describe('stable visual surfaces', () => {
  test('homepage hero remains stable', async ({ page }) => {
    ...
    await expect(page.locator('.hero-content')).toHaveScreenshot('home-hero.png', {
      animations: 'disabled',
      caret: 'hide',
      scale: 'css',
  ...
  test('search landing panel remains stable', async ({ page }) => {
    ...
    await expect(page.locator('.search-header')).toHaveScreenshot('search-panel.png', {
      animations: 'disabled',
      caret: 'hide',
      scale: 'css',
      maxDiffPixelRatio: 0.01
  ...
  test('gallery featured row remains stable', async ({ page }) => {
    ...
    await expect(page.locator('.gallery-featured')).toHaveScreenshot('gallery-featured.png', {
      animations: 'disabled',
      caret: 'hide',
      scale: 'css',
      maxDiffPixelRatio: 0.01
